...
void main() {
  ...
  group('AppColors', () {
    test(
      'primaryContainer should equal #0077B6 per Agile Plan spec',
      () {
        // Arrange
    ...
    test(
      'surface should equal #F7FAFE per design system spec',
      () {
        // Arrange
    ...
    test(
      'error should equal #BA1A1A per design system spec',
      () {
        // Arrange
    ...
    test(
      'ambientShadow alpha should be 0x14 (8% opacity) per design spec',
      () {
  ...
  group('AppTheme', () {
    testWidgets(
      'light theme should use Material 3',
      (tester) async {
