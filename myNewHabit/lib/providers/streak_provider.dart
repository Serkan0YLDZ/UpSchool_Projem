// Sprint 6: Seri state — reconcile, kurtarma, görünürlük verisi
...
class StreakProvider extends ChangeNotifier {
  ...
  /// UI katmanının `StreakService`'e doğrudan bağlanmaması için.
  ...
  Future<void> reconcileForRecord(String recordId) async {
    ...
    agentArchDebugLog(
      hypothesisId: 'H2',
      location: 'streak_provider.dart:reconcileForRecord',
      message: 'entry',
    ...
    agentArchDebugLog(
      hypothesisId: 'H2',
      location: 'streak_provider.dart:reconcileForRecord',
      message: 'after_getById',
      data: {
        'recordId': recordId,
        'habitNull': habit == null,
        if (habit != null) 'type': habit.type.name,
        if (habit != null) 'isHabit': habit.type.isHabit,
      },
    );
    // #endregion
