...
/// E-posta + şifre ile mock giriş (bottom sheet — brutalist tema, klavye ile kaydırılabilir).
///
/// [MainShell] özel alt barı modalın üstünde olduğu için içerik altına
/// [AppSpacing.mainShellBottomNavHeight] + güvenli alan payı eklenir.
Future<void> showProfileEmailSignInSheet(
  ...
  return showModalBottomSheet<void>(
    ...
    barrierColor: AppColors.brutalistBlack.withValues(alpha: 0.35),
    builder: (sheetContext) {
      return _EmailSignInSheetBody(onSignIn: onSignIn);
    },
  );
}
