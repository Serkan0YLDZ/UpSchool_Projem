...
import '../utils/habit_schedule.dart';
...
abstract final class StreakService {
  static String mondayWeekKeyFromYmd(String yyyyMmDd) =>
      mondayWeekKey(DateTime.parse(yyyyMmDd));
