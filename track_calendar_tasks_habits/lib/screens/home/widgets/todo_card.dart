...
class _TodoCardBody extends StatelessWidget {
  ...
  Color _priorityColor(BuildContext context) {
    ...
    return switch (record.priority) {
      Priority.high => track.todoPriorityHigh,
      Priority.medium => track.todoPriorityMedium,
      Priority.low => track.todoPriorityLow,
  ...
  Color _priorityLabelColor(BuildContext context) {
    ...
    final ink = track.brutalistInk;
    return switch (record.priority) {
      Priority.high => track.brutalistSurface,
      Priority.medium => ink,
      Priority.low => ink,
      _ => track.brutalistSurface,
    };
  }

  String _priorityLabel() => switch (record.priority) {
