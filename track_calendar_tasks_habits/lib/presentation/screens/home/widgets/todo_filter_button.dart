...
class TodoFilterButton extends StatelessWidget {
  ...
  void _showFilterSheet(BuildContext context, TodoProvider initialProvider) {
    showModalBottomSheet<void>(
      context: context,
      useRootNavigator: true,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (ctx) => Consumer<TodoProvider>(
                    ...
                    children: [
                      ...
                      TodoFilterOption(
                        ...
                        isSelected: provider.activeFilters
                            .contains(TodoFilterType.todoDone),
                        onTap: () => provider.toggleFilter(TodoFilterType.todoDone),
                        ink: ink,
                      ),
                      TodoFilterOption(
                        label: 'Yapılacaklar',
                        ...
                        isSelected: provider.activeFilters
                            .contains(TodoFilterType.todoTodo),
                        onTap: () => provider.toggleFilter(TodoFilterType.todoTodo),
                        ink: ink,
                      ),
                      const SizedBox(height: AppSpacing.lg),
                      ...
                      TodoFilterOption(
                        ...
                        isSelected: provider.activeFilters
                            .contains(TodoFilterType.mostImportant),
                        onTap: () =>
                      ...
                      TodoFilterOption(
                        ...
                        isSelected: provider.activeFilters
                            .contains(TodoFilterType.earliest),
                        onTap: () => provider.toggleFilter(TodoFilterType.earliest),
                        ink: ink,
                      ),
                      const SizedBox(height: AppSpacing.lg),
                      ...
                      TodoFilterOption(
                        ...
                        isSelected: provider.activeFilters
                            .contains(TodoFilterType.thisWeek),
                        onTap: () => provider.toggleFilter(TodoFilterType.thisWeek),
                        ink: ink,
                      ),
                      TodoFilterOption(
                        label: 'Bu Ay',
                        ...
                        isSelected: provider.activeFilters
                            .contains(TodoFilterType.thisMonth),
                        onTap: () => provider.toggleFilter(TodoFilterType.thisMonth),
                        ink: ink,
                      ),
                      const SizedBox(height: AppSpacing.lg),
                    ],
