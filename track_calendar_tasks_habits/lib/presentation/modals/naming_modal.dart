...
class _NamingSheetState extends State<_NamingSheet> {
  ...
  List<String> get _suggestions => switch (widget.type) {
    ItemType.habit => ['Su İç 💧', 'Kitap Oku 📚', 'Spor Yap 🏃', 'Meditasyon 🧘'],
    ItemType.event => ['Toplantı 💼', 'Randevu 📅', 'Sinema 🍿', 'Kutlama 🎉'],
    ItemType.todo => ['Alışveriş 🛒', 'Fatura Öde 💳', 'Mail Gönder 📧', 'Evi Temizle 🧹'],
  };

  String get _hintText => switch (widget.type) {
    ItemType.habit => 'Alışkanlık adı...',
    ItemType.event => 'Etkinlik adı...',
    ItemType.todo => 'Yapılacak şeyin adı...',
  };
            ...
            children: [
              ...
              Transform.rotate(
                ...
                child: Container(
                  ...
                  child: Text(
                    widget.type == ItemType.habit
                        ? 'ALIŞKANLIĞINA BİR\nİSİM VER!'
                        : widget.type == ItemType.event
                            ? 'ETKİNLİĞİNE BİR\nİSİM VER!'
                            : 'YAPILACAK ŞEYE\nBİR İSİM VER!',
                    style: TextStyle(
                      fontSize: 24,
