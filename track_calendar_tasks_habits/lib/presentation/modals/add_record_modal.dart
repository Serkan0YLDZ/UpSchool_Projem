...
Future<void> showAddRecordModal(
  ...
  required void Function(ItemType type) onTypeSelected,
}) {
...
class _AddRecordSheet extends StatelessWidget {
  ...
  final void Function(ItemType type) onTypeSelected;
        ...
        child: Column(
          ...
          children: [
            ...
            _TypeTile(
              ...
              onTap: () => onTypeSelected(ItemType.event),
            ),
            const SizedBox(height: AppSpacing.md),
            _TypeTile(
              ...
              labelColor: Colors.white,
              subtitleColor: Colors.white.withValues(alpha: 0.9),
              onTap: () => onTypeSelected(ItemType.habit),
            ),
            const SizedBox(height: AppSpacing.md),
            _TypeTile(
              ...
              labelColor: Colors.white,
              subtitleColor: Colors.white.withValues(alpha: 0.9),
              onTap: () => onTypeSelected(ItemType.todo),
            ),
